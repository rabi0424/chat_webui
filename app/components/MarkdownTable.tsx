...
function CopyTableButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="rounded p-1 text-ink-3 opacity-0 transition-opacity group-hover/table:opacity-100 focus-visible:opacity-100 touch:opacity-100 touch:p-2 hover:bg-neutral-200 hover:text-neutral-700 dark:hover:bg-neutral-700 dark:hover:text-neutral-200"
    >
      {copied ? (
